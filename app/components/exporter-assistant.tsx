...
export function AssistantExportMessageModal(props: { onClose: () => void }) {
    return (
...
export function ExportAvatar(props: { avatar?: string, src?: string }) {
    if (props.avatar === DEFAULT_MASK_AVATAR || props.src) {
        return (
            <div className="user-avatar">
                <img
                    src={props.src || BotIcon.src}
                    width={24}
                    height={24}
                    alt="bot"
                />
        ...
        <div className={styles["image-previewer"]}>
            ...
            >
                <div className={styles["chat-info"]}>
                    ...
                    <div>
                        <div className={styles["main-title"]}>CONSULTANT GUIDE</div>
