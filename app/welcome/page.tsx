...
const roleCard = {
    [ROLE.STUDENT] : [
        {title: '预约咨询', subTitle: 'reserve', key: 'student/appointment', },
        {title: '任务中心', subTitle: 'task', key: 'gpt', },
        {title: '信息中心', subTitle: 'information', key: 'profile', },
        {title: '产品中心', subTitle: 'service', key: 'product', },
    ...
    [ROLE.COUNSELOR] : [
        {title: '顾问申请', subTitle: 'reserve', key: 'counselor/apply', },
        {title: '管理日程', subTitle: 'service', key: 'counselor/schedule', },
        {title: '信息中心', subTitle: 'service', key: 'counselor/profile', },
        {title: 'GPT', subTitle: 'GPT', key: 'gpt', },
    ],
    [ROLE.CHANNEL] : [
    ...
    [ROLE.ADMIN] : [
        ...
        {title: '服务管理', subTitle: 'service', key: 'service', },
